...
# ── Routers ────────────────────────────────────────────────────────────────────
from app.routers import auth, box, campaign, catalog, center, dashboard, intake, pallet, product_type, shipment, transfer, users, studio, requests as requests_router
