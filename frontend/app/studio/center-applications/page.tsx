...
// Superadmin review queue. The studio layout already guards `platformRole ===
// "superadmin"`; this is a defense-in-depth check plus the data fetch.
export default async function StudioCenterApplicationsPage() {
