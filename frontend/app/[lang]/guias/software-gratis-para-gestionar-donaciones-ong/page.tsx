...
const CONTENT: Record<Locale, Content> = {
  es: {
    ...
    criterios: [
      ...
      { title: "Datos personales al mínimo", desc: "Que no te obligue a registrar datos de beneficiarios, y que los del donante sean opcionales y con plazo de conservación: menos riesgo legal y menos fricción." },
  ...
  en: {
    ...
    criterios: [
      ...
      { title: "Personal data kept minimal", desc: "It shouldn't force you to record recipient data, and donor data should be optional and have a retention period: less legal risk and less friction." },
