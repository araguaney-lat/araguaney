...
const CONTENT: Record<Locale, Content> = {
  es: {
    ...
    rows: [
      ...
      { cap: "Sin datos personales (privacidad)", sheet: "Depende de quién la llene", ara: "Por diseño" },
  ...
  en: {
    ...
    rows: [
      ...
      { cap: "No personal data (privacy)", sheet: "Depends who fills it in", ara: "By design" },
