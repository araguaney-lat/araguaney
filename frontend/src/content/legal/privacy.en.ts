  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        "The specific provider and its country depend on each deployment's configuration, and may be a service located in the United States or a model run locally with no transfer at all. If this feature is enabled in the deployment you use, you may request the details of the current provider at the contact address in this notice.",
