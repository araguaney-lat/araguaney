...
| 7 | Gestión desde el panel | Ver, agregar y borrar alias de un producto, para la administración nacional. Necesario antes de la task 6: un alias aprendido tiene que ser visible y reversible por alguien. | 🟠 Media | ⬜ Pendiente |
