...
| 6 | Entrada en Wikidata (QID) | Crear la entidad en Wikidata y enlazarla vía `sameAs`. Entidad "home" que Google/IA usan para resolver la marca. Costo bajo, impacto alto. | 🟢 | 🟡 Preparada — payload de QuickStatements con propiedades y QIDs verificados contra la API de Wikidata en [`docs/seo/entity-registration.md`](../seo/entity-registration.md). **Bloqueada a propósito**: el criterio 2 de notabilidad exige referencias independientes y hoy solo tenemos autopublicadas; crear el ítem antes arriesga una solicitud de borrado. Se ejecuta después de la task 8. |
...
| 8 | Menciones de marca / directorios | Alta en directorios relevantes: Product Hunt, listados de tecnología humanitaria, Digital Public Goods, ReliefWeb/HDX, catálogos de software. Menciones de marca > backlinks para IA. | 🟡 | 🟡 En curso — autoevaluación contra los 9 indicadores del DPG Standard: 10 de 11 se cumplen con evidencia ya en el repo. Única brecha (indicador 1, relevancia ODS) cerrada en este PR con la sección de ODS del README. Lista priorizada de directorios y copy listo para formularios en [`docs/seo/entity-registration.md`](../seo/entity-registration.md). Falta postular. |
