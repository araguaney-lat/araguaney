...
| 17 | [AEO/GEO + expansión de keywords](phase-17-aeo-keyword-expansion.md) | 2 | 19 | 🟡 10% |
| **Total** | | **320** | **31** | **🟡 91%** |
...
>   "¿recibir donativos?").
> - **19 nuevas (Fase 17 — AEO/GEO + expansión de keywords):** trabajo de posicionamiento
>   ejecutable sin gate de pago (Bing/IndexNow, entidad/Wikidata, comparativas, escenarios,
>   frescura, medición de visibilidad en IA). Tasks 4 (host canónico) y 5 (señales de entidad) ✅.
