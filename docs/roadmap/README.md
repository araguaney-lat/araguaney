...
| 18 | [Pre-registro de donaciones por el donante](phase-18-donor-preregistration.md) | 18 | 5 | 🟡 78% |
...
> - **5 de la Fase 18 (pre-registro de donaciones):** backend, frontend público, recepción en el
>   centro y purga listos; faltan las fotos, el reenvío del enlace de confirmación (task 22, un hueco
>   que las tasks 3, 6 y 13 daban por cubierto), la pasada de seguridad, lo legal y el email de envío;
>   diseño en [el spec](../superpowers/specs/2026-07-29-donor-preregistration-design.md).
