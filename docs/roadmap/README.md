...
| 22 | [Trazabilidad extendida: avión y destino](phase-22-extended-traceability.md) | 10 | 4 | 🟡 71% |
...
> - **4 de la Fase 22 (trazabilidad extendida):** hitos, llegada, timeline, recepción, incidencias y la
>   ficha pública que ya dice si la carga llegó; faltan los reportes, el manual, los tests de cierre y
>   `CLAUDE.md`. Diseño en
