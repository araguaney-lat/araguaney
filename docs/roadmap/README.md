...
| 19 | [Identidad estructurada del donante en el intake](phase-19-structured-donor-identity.md) | 8 | 1 | 🟡 89% |
...
> - **1 de la Fase 19 (identidad estructurada del donante):** solo queda la tarea legal (aviso de
>   privacidad y retención). El backend, el formulario y las pruebas están listos.
