...
| 18 | [Pre-registro de donaciones por el donante](phase-18-donor-preregistration.md) | 16 | 6 | 🟡 73% |
...
> - **6 de la Fase 18 (pre-registro de donaciones):** backend, frontend público y recepción en el
>   centro listos; faltan las fotos, la purga, la pasada de seguridad, lo legal y el email de envío;
