...
| 22 | [Trazabilidad extendida: avión y destino](phase-22-extended-traceability.md) | 11 | 3 | 🟡 79% |
...
> - **3 de la Fase 22 (trazabilidad extendida):** el ciclo completo funciona, de los hitos a la merma
>   en reportes; faltan el manual de recepción, los tests de cierre y la actualización de la máquina
>   de estados en `CLAUDE.md`. Diseño en
