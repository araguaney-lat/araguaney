...
| 18 | [Pre-registro de donaciones por el donante](phase-18-donor-preregistration.md) | 5 | 17 | 🟡 23% |
...
> - **17 de la Fase 18 (pre-registro de donaciones):** el tramo backend (modelos, repositorios, alta con doble opt-in, QR y correos) está listo; diseño en
