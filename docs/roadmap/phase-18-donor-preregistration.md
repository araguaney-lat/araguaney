...
| 22 | Reenvío del enlace de confirmación | Las tasks 3, 6 y 13 lo daban por hecho, pero nunca se implementó: hoy quien no recibe el correo de confirmación no tiene forma de pedirlo de nuevo y su donación vence. Endpoint público con Turnstile + límite de tasa que rota el token de verificación (el anterior deja de servir) y reenvía el correo, más el botón en la página de "revisa tu correo". | 🟠 Media | ⬜ |
